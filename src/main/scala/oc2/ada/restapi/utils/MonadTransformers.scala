...
/**
 * Monad transforma sus clases que amplían las mónadas predeterminadas como Future u Option.
 * Manejan la situación cuando las mónadas se contienen entre sí, lo que ayuda a reducir la cantidad de código repetitivo.
 * Por ejemplo, en ese proyecto hay muchas clases Future[Option[T]] que deben manejarse de alguna manera.
 */
